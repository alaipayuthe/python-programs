...
def encrypt(phrase, cipher_dict):
    ...
    for letter in phrase:
        answer = answer + cipher_dict[letter]
    return answer
...
# Compute an inverse substitution cipher that decrypts
# an encrypted phrase
...
#{'p': 'f', 'n': 'l', 'm': 'a', 'i': 'i', 'd': 'd', 'x': 'k', 'b': ' ', 'l': 'v', 'f': 'g',
#'o': 's', 'u': 'e', 'a': 'n', 'c': 'y', 'r': 'q', 'e': 'z', 'k': 'c', 'w': 'm', 'g': 'r',
