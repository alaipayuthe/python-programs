...
#{'p': 'f', 'n': 'l', 'm': 'a', 'i': 'i', 'd': 'd', 'x': 'k', 'b': ' ',
#'l': 'v', 'f': 'g', 'o': 's', 'u': 'e', 'a': 'n', 'c': 'y', 'r': 'q',
#'e': 'z', 'k': 'c', 'w': 'm', 'g': 'r', 'y': 'o', ' ': 't', 'h': 'h',
#'v': 'p', 'j': 'x', 'q': 'u', 't': 'w', 's': 'b', 'z': 'j'}
#pig
#hello world
...
def make_cipher_dict(alphabet):
    ...
    if bool(alphabet):
        ...
        print(letter_list)
        shuffle_list = list(letter_list)
        random.shuffle(shuffle_list)
        print(shuffle_list)
        index = 0
        for letter in letter_list:
            output_dict[letter] = shuffle_list[index]
            index += 1
    return output_dict
...
#{}
#{'a': 'a', 't': 'c', 'c': 't'}
#{'a': 'h', 'l': 'u', 'u': 'q', 'b': 'v', 'y': 'a', 'm': 'r', 'p': 'j',
#'k': 'e', 'n': 'p', 't': 'x', 'd': 'o', 'c': 'c', 'w': ' ', 'f': 'd',
#'r': 'z', 'v': 'l', 's': 'y', 'e': 'b', 'o': 'i', 'x': 'm', 'h': 's',
#'i': 'w', 'q': 'g', 'g': 'n', 'j': 'f', 'z': 'k', ' ': 't'}
